...
const DEMO_METADATA: Metadata = sampleMetadata({
  slug: 'arche-wellness',
  title:
    '아르케 웰니스 (ARCHE WELLNESS) — 프라이빗 필라테스 & 스파 인테리어',
  description:
    '태문 DEV STUDIO 가 만든 가상 브랜드 샘플입니다. 실제 업체가 아니며 체험 신청은 접수되지 않습니다. 3대 특화 룸 핫스팟 투어, 실내 공기 텔레메트리 HUD, 친환경 마감재 아카이브를 한 페이지에 담았습니다.',
});

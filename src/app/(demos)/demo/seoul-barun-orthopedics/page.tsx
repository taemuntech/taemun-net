...
const DEMO_METADATA: Metadata = sampleMetadata({
  ...
  description:
    ...
    '태문넷이 만든 가상 브랜드 샘플입니다. 실제 의료기관이 아니며 진료 예약은 접수되지 않습니다. 화면의 의료진·장비·수치·진료비는 모두 예시입니다. 부위별 통증 자가체크(의학적 진단이 아닙니다), 당일 MRI 원스톱 예약 화면, 100평 규모 1:1 도수운동재활센터와 비수술 치료 안내를 한 페이지에 담았습니다.',
});

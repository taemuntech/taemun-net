...
const DEMO_METADATA: Metadata = sampleMetadata({
  ...
  description:
    '태문 DEV STUDIO 가 만든 가상 브랜드 샘플입니다. 실제 업체가 아니며 파트너링·기술이전 신청은 접수되지 않습니다. 임상 단계별 파이프라인 매트릭스와 프로토콜 요약 모달, 분자 작용 기전(MoA) 시뮬레이션, 연구·생산 인프라 소개, 과학 자문단과 논문 초록을 한 페이지에 담았습니다.',
});

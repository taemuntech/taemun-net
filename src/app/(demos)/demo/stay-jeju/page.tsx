...
const DEMO_METADATA: Metadata = sampleMetadata({
  slug: 'stay-jeju',
  title:
    '소소재 제주 (SOSOJAE JEJU) — 애월 프라이빗 독채 스테이 공간 디자인',
  description:
    '태문 DEV STUDIO 가 만든 가상 브랜드 샘플입니다. 실제 업체가 아니며 예약 신청은 접수되지 않습니다. 시간대별 조명 연출, 공간별 핀 핫스팟 투어, 제주 자연 물성 아카이브를 한 페이지에 담았습니다.',
});

...
const DEMO_METADATA: Metadata = sampleMetadata({
  ...
  description:
    '태문넷이 만든 가상 브랜드 샘플입니다. 실제 업체가 아니며 주문·결제는 접수되지 않습니다. AI 반려동물 영양 프로파일러(RER/DER 급여량 계산), 실물 100원 동전 대비 키블 1:1 스케일 뷰어, 수의사 온라인 무료 문진 연계, 영양 리포트(인쇄/PDF) 및 정기구독 15% 카트 드로어를 한 페이지에 담았습니다.',
});

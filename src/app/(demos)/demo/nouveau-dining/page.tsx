...
const DEMO_METADATA: Metadata = sampleMetadata({
  slug: 'nouveau-dining',
  title:
    '누보 다이닝 (NOUVEAU DINING) — 하이엔드 카페 & 레스토랑 인테리어',
  description:
    '태문 DEV STUDIO 가 만든 가상 브랜드 샘플입니다. 실제 업체가 아니며 상담 신청은 접수되지 않습니다. 오픈 셰프 카운터 바와 온실 테라스 가든, 3단계 조도 앰비언스 시뮬레이션, 마감재 아카이브를 한 페이지에 담았습니다.',
});

...
const DEMO_METADATA: Metadata = sampleMetadata({
  ...
  description:
    '태문넷이 만든 가상 브랜드 샘플입니다. 실제 업체가 아니며 주문·결제는 접수되지 않습니다. 실시간 24K 골드박·불도장 각인 시뮬레이터, 4가지 전통 보자기 매듭 룩북, 카테고리·검색·정렬이 실제로 동작하는 백자 다기·황동 롤러볼 펜 컬렉션, 기념일 희망일 예약 배송 안내 및 슬라이드 카트 드로어를 한 페이지에 담았습니다.',
});

...
const DEMO_METADATA: Metadata = sampleMetadata({
  slug: 'aether-medical',
  title:
    '에테르 메디컬 (AETHER MEDICAL) — 청담 VIP 프라이빗 메디컬 인테리어',
  description:
    '태문 DEV STUDIO 가 만든 가상 브랜드 샘플입니다. 실제 업체가 아니며 상담 신청은 접수되지 않습니다. 빛과 곡면의 메디컬 인테리어, 차음 설계 예시 수치, 서카디언 조도 텔레메트리 HUD, 마감재 아카이브를 한 페이지에 담았습니다.',
});

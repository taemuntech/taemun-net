...
const DEMO_METADATA: Metadata = sampleMetadata({
  ...
  description:
    '태문넷이 만든 가상 브랜드 샘플입니다. 실제 의료기관이 아니며 진료 예약은 접수되지 않습니다. 화면의 의료진·병상·진료비·약재 정보는 모두 예시입니다. 의·한의 통합 진료와 수술 후 재활 안내, 전 객실 1인실·2인실 모션베드 360 가상 투어, hGMP 규격 청정 탕전 로트 조회 화면, 병동 현황 안내(예시 데이터)와 입원 예약 문의 화면을 한 페이지에 담았습니다.',
});

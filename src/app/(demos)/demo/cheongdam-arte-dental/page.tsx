...
const DEMO_METADATA: Metadata = sampleMetadata({
  ...
  description:
    '태문 DEV STUDIO 가 만든 가상 브랜드 샘플입니다. 실제 의료기관이 아니며 진료 예약은 접수되지 않습니다. 3D 컴퓨터 모의수술 네비게이션 임플란트 가이드, 자연치아 보존 0.1mm 라미네이트 비포&애프터 슬라이더, 4단계 컴퓨터 무통 마취 시스템, VIP 실시간 간편예약 및 안심 사전 문진표를 한 페이지에 담았습니다.',
});

...
const DEMO_METADATA: Metadata = sampleMetadata({
  ...
  description:
    ...
    '태문넷이 만든 가상 브랜드 샘플입니다. 실제 의료기관이 아니며 진료 예약은 접수되지 않습니다. 화면의 의료진·수치·진료비는 모두 예시이고, 전후 비교 화면의 사진은 실제 환자가 아닌 예시 이미지입니다(결과에는 개인차가 있고 부작용이 있을 수 있습니다). 1:1:0.8 안면 비율 시뮬레이터, 예시 이미지 전후 비교 뷰어, 수술 실명제·1:1 마취과 전문의·보호자 CCTV 등 5대 안심안전망, 1인 VIP 리커버리 케어 안내를 한 페이지에 담았습니다.',
});

                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-white flex items-center gap-1.5">
                        <span>공정 데이터 데모</span>
                        <span className="text-[9px] px-1.5 rounded-full bg-emerald-500/20 text-emerald-300 font-bold">LIVE</span>
                      </div>
                      <div className="text-xs text-gray-400 mt-0.5">리튬 호일 제조 KPI·수율 대시보드</div>
                    </div>
                  </div>

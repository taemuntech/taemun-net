      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-12">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#006948]/10 border border-[#006948]/20 mb-6">
          ...
          <span className="font-mono text-[10px] lg:text-[11px] text-[#006948] tracking-wider uppercase font-semibold">
            BIOPHILIC PRECISION AI VERTICAL FARMING // ESG RE100 COMPLIANT
          </span>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="p-6 rounded-xl bg-white border border-[#bccac0]/40 hover:border-[#006948] transition-all shadow-2xs">
            ...
            <p className="font-body text-sm text-[#3d4a42] leading-relaxed">
              순환 여과 에어로포닉스 분무 시스템을 통해 관행 토경 재배 대비 농업용수를 95% 이상 획기적으로 절감합니다.
            </p>
          </div>
          ...
          <div className="p-6 rounded-xl bg-white border border-[#bccac0]/40 hover:border-[#006948] transition-all shadow-2xs">
            ...
            <p className="font-body text-sm text-[#3d4a42] leading-relaxed">
              최대 16단 고밀도 수직 스택 타워와 24시간 분광 가속으로 일반 노지 농업 대비 단위면적당 40배 이상의 생산성을 보장합니다.
            </p>
          </div>

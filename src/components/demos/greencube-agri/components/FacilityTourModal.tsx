        ...
        <div className="p-6">
          {submitted ? (
            <div className="text-center py-8 space-y-3">
              <div className="w-14 h-14 bg-[#006948]/10 text-[#006948] rounded-full flex items-center justify-center mx-auto">
                <span className="material-symbols-outlined text-3xl">check</span>
              </div>
              <h4 className="font-headline text-xl font-bold text-[#131b2e]">
                투어 예약 접수가 완료되었습니다
              </h4>
              <p className="font-body text-xs text-[#3d4a42] leading-relaxed">
                클린룸 방진복 사이즈 확인 및 출입 방역 보안 서약서 발송을 위해 사전 예약 담당자가 24시간 이내 유선 안내를 드립니다.
              </p>
              <button
                onClick={() => {
                  setSubmitted(false);
                ...
                className="mt-4 px-5 py-2 bg-[#006948] text-white font-mono text-xs rounded-lg hover:bg-[#00855d]"
              >
                확인
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="p-3 bg-[#f2f3ff] rounded-lg border border-[#bccac0]/30 font-body text-xs text-[#3d4a42]">
                <strong className="text-[#006948]">안내:</strong> 진천 기가팜은 ISO Class 1000 클린룸 시설로서 에어샤워 및 정전기 방지 방진복 착용 후 참관이 진행됩니다.
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <option value="sejong">세종 테크노밸리 AI 아그로 R&amp;D 실증 센터</option>
                </select>
              </div>

      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between text-[10px] lg:text-[11px] font-mono tracking-wider">
        <div className="flex items-center space-x-4 shrink-0">
          ...
          >
            ...
            <span className="text-[#85f8c4] font-medium">CLEANROOM: ISO CLASS 1000 (0.3µm HEPA Active)</span>
          </button>
        ...
        <div className="hidden lg:flex items-center gap-4 text-[#bccac0]">
          ...
          <span>•</span>
          <span className="text-[#6ffbbe] font-semibold">ESG RE100 100% AUDITED</span>
        </div>
      </div>
    </div>
  );

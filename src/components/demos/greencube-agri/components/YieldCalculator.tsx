      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12">
          ...
          <div className="mt-4 lg:mt-0 font-mono text-[11px] text-[#6d7a72] flex items-center gap-2">
            ...
            기준: 진천 제1 기가-바이오스피어 2024 실측 데이터 적용
          </div>
        </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-[#f2f3ff] p-6 rounded-xl border border-[#bccac0]/40 flex flex-col justify-between shadow-2xs">
              ...
              <div className="mt-4 pt-3 border-t border-[#bccac0]/20 flex justify-between font-mono text-[11px]">
                ...
                <span className="text-[#006948] font-bold">&lt; 1.2% (업계 최저)</span>
              </div>
            </div>
            ...
            <div className="bg-[#f2f3ff] p-6 rounded-xl border border-[#bccac0]/40 flex flex-col justify-between shadow-2xs">
              ...
              <div className="mt-4 pt-3 border-t border-[#bccac0]/20 flex justify-between font-mono text-[11px]">
                ...
                <span className="text-[#00687a] font-bold">95.4% 감소</span>
              </div>
            </div>
            ...
            <div className="bg-[#f2f3ff] p-6 rounded-xl border border-[#bccac0]/40 flex flex-col justify-between shadow-2xs">
              ...
              <div className="mt-4 pt-3 border-t border-[#bccac0]/20 flex justify-between font-mono text-[11px]">
                <span className="text-[#6d7a72]">ESG RE100 인증</span>
                <span className="text-[#006947] font-bold">Scope-1/Scope-3 적합</span>
              </div>
            </div>

...
export const RehabSuiteSection: React.FC<RehabSuiteSectionProps> = ({
  ...
  return (
    <section id="rehab-center" className="w-full bg-[#F4F3F1] py-12 lg:py-16 scroll-mt-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-10">
          <div className="lg:col-span-7">
            ...
            <h2 className="text-2xl lg:text-3xl font-bold text-[#1A1C1A] tracking-tight leading-snug">
              통증의 완화를 넘어 재발을 막는 <br />
              100평 규모 1:1 맞춤형 도수·운동치료센터
            </h2>
            <p className="text-sm lg:text-base text-[#3F493F] mt-2 max-w-xl leading-relaxed">
              국가공인 전문 물리치료사와 환자 1인을 1:1로 밀착 매칭합니다. 
              단순 마사지식 도수가 아닌, 첨단 바이오메카닉스 기구와 심부 근육 활성화 프로토콜을 통하여 척추 축과 관절의 정상 가동범위를 영구적으로 복원합니다.
            </p>
            <div className="pt-4">
              <button
                onClick={onBookConsultation}
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#00652C] hover:bg-[#15803D] text-white text-xs lg:text-sm font-bold shadow-sm transition-all cursor-pointer"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {REHAB_EQUIPMENT.map((item) => (
            <div
              ...
              className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[#E9E8E5] flex flex-col justify-between group hover:shadow-md transition-all cursor-pointer"
            >

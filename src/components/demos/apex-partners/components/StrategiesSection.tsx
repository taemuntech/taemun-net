          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 bg-[#090e17] border border-[#4d4635]/40 rounded-xl p-6 lg:p-8 flex flex-col justify-between">
              <div>
                ...
                {/* 수치 고지 — 전략별 티켓·목표 수익률은 가상 설정이다 */}
                <p className="mt-4 font-mono-metric text-[11px] text-[#d0c5af]/70 leading-relaxed">
                  * 티켓 규모·목표 수익률·회수 배수는 가상 설정의 예시 수치입니다.
                </p>
              </div>

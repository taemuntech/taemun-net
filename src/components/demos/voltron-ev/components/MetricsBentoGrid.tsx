      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <p className="font-body text-xs text-[#bac9cc] leading-relaxed">
            World-record SiC conversion rate minimizing parasitic thermal loss via planar busbar integration.
          </p>
        </div>
        ...
        >
          ...
          <p className="font-body text-xs text-[#bac9cc] leading-relaxed">
            10% to 80% State of Charge (SoC) replenishment utilizing native 800V DC bus continuous absorption.
          </p>
        </div>
        ...
        >
          ...
          <p className="font-body text-xs text-[#bac9cc] leading-relaxed">
            612 PS with 920 Nm instantaneous torque density, validated across continuous Nürburgring hot-laps.
          </p>
        </div>
        ...
        >
          ...
          <p className="font-body text-xs text-[#bac9cc] leading-relaxed">
            Co-axial 3-in-1 e-Axle structural integration discarding external HV harness copper weight.
          </p>
        </div>
      </div>
    </div>

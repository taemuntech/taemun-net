...
import { Sliders, Download, Terminal, Shield, Zap, CircleDot } from 'lucide-react';
      ...
      <div className="max-w-[1720px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-4">
          ...
          >
            ...
            TIER-1 OEM ARCHITECTURE // ASIL-D ISO 26262
          </span>
          <span
            id="badge-gen3-sic"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
          <div className="lg:col-span-8 space-y-4">
            ...
            <p className="font-body text-base lg:text-lg text-[#bac9cc] max-w-3xl leading-relaxed">
              Porsche Taycan &amp; Rimac caliber Tier-1 powertrain engineering. Integrating
              ...
              mission-critical commercial platforms.
            </p>

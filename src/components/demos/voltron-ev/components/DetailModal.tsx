...
import { X, Download, ShieldCheck, CheckCircle2, FileText, Cpu, Compass, HardDrive } from 'lucide-react';
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 p-5 bg-[#101319] border-t border-[#3b494c]/40">
          <div className="flex items-center gap-2 text-[11px] font-code text-[#849396]">
            ...
            <span>ISO 26262 ASIL-D VALIDATED // PANGYO WAFER FAB</span>
          </div>

          <div className="flex items-center gap-3">
            <button
              onClick={() => {
                alert(`Exporting official engineering datasheet package for ${component.code}...`);
                onClose();
              }}

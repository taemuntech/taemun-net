      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-4">
          <div className="inline-flex items-center space-x-1.5 bg-[#132033] border border-[#2563eb]/40 px-3 py-1 rounded text-[#b4c5ff] font-mono text-xs">
            ...
            <span>IMO 2030 / 2050 Zero-Emission Net Zero Charter</span>
          </div>
          ...
          <div className="inline-flex items-center space-x-1.5 bg-[#132033] border border-[#fe6b00]/40 px-3 py-1 rounded text-[#ffb693] font-mono text-xs">
            ...
            <span>Level 4 Maritime Autonomy Certified</span>
          </div>
          ...
          <div className="inline-flex items-center space-x-1.5 bg-[#1d2a3e] px-2.5 py-1 rounded text-[#c3c6d7] font-mono text-xs">
            ...
            <span>1,850,000 TEU Live Monitored</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-8">
          <div className="lg:col-span-8">
            ...
            <p className="text-[#c3c6d7] text-sm lg:text-base max-w-3xl leading-relaxed">
              ...
              초정밀 AIS 텔레메트리와 실시간 스마트 적재 알고리즘으로 탄소 발자국을 38.6% 감축하며 99.4% 정시성을 제공합니다.
            </p>
          </div>
          ...
          <div className="lg:col-span-4 flex flex-col space-y-3">
            ...
            <div className="font-mono text-[11px] text-[#8d90a0] text-center flex items-center justify-center space-x-2">
              ...
              <span>ANSI X12 &amp; UN/EDIFACT API v4.2 Ready</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative rounded-lg overflow-hidden border border-[#434655]/40 shadow-2xl bg-[#132033]">
          ...
          <div className="absolute top-3 left-3 max-w-xs bg-[#132033]/90 backdrop-blur-md border border-[#434655]/60 rounded-lg p-3 lg:p-4 text-[#d6e3fe] shadow-xl">
            <div className="flex items-center justify-between pb-1.5 border-b border-[#434655]/30 mb-2">
              ...
              <span className="font-mono text-xs text-[#b4c5ff]">IMO 9928174</span>
            </div>
            ...
            <p className="font-mono text-[11px] text-[#c3c6d7] mb-2.5">
              Capacity: 24,000 TEU • Dual-Fuel Green Methanol
            </p>
            ...
            <div className="grid grid-cols-2 gap-2 font-mono text-[11px] pt-2 border-t border-[#434655]/30">
              ...
              <div>
                ...
                <span className="text-[#b4c5ff] font-semibold">100% Starlink Mesh</span>
              </div>
            </div>
          </div>

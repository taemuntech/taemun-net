  ...
  return (
    <footer className="bg-[#020e21] border-t border-[#434655]/30 w-full px-4 lg:px-8 py-12">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Bottom Disclaimers */}
        <div className="pt-6 flex flex-col lg:flex-row justify-between items-center text-[#8d90a0] font-mono text-xs gap-3">
          <p className="text-center lg:text-left">
            &copy; 2025 Transocean Global SCM Corp. All Global Rights Reserved. IMO License #8930421 | FMC Carrier #028491.
          </p>
          <div className="flex flex-wrap justify-center space-x-4">
            <span>B/L STANDARD: TOCU-2025</span>

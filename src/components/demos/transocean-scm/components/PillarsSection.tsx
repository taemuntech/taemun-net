          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 bg-[#132033] border border-[#434655]/30 rounded-lg p-6 lg:p-8 items-center shadow-xl">
            <div className="lg:col-span-6">
              ...
              <p className="text-sm text-[#c3c6d7] leading-relaxed mb-6">
                ...
                항만 병목 현상을 원천 차단하고 컨테이너 선적·양하 작업 주기를 28% 단축시킵니다.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="border-l-2 border-[#2563eb] pl-3">
                  ...
                  <div className="text-xs text-[#8d90a0]">Per Crane Productivity</div>
                </div>
                <div className="border-l-2 border-[#fe6b00] pl-3">
                  <div className="font-mono text-xl lg:text-2xl font-bold text-[#ffb693]">0.00% Incident</div>
                  <div className="text-xs text-[#8d90a0]">Autonomous Safety Record</div>
                </div>
              </div>
            ...
            <div className="lg:col-span-6 bg-[#0e1c2f] p-4 lg:p-5 rounded-lg border border-[#434655]/30">
              <div className="flex justify-between items-center mb-3 pb-2 border-b border-[#434655]/30">
                <span className="font-mono text-xs text-[#ffb693] uppercase font-semibold">
                  BUSAN SMART TERMINAL YARD A4 TELEMETRY
                </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 bg-[#132033] border border-[#434655]/30 rounded-lg p-6 lg:p-8 items-center shadow-xl">
            <div className="lg:col-span-6">
              ...
              <p className="text-sm text-[#c3c6d7] leading-relaxed mb-6">
                ...
                선박 저항을 최소화하고 양하 포트별 재작업(Re-handling)을 94% 절감합니다.
              </p>

              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="border-l-2 border-[#2563eb] pl-3">
                  <div className="font-mono text-xl lg:text-2xl font-bold text-white">-94.2%</div>
                  <div className="text-xs text-[#8d90a0]">Unnecessary Shift Moves</div>
                </div>
                <div className="border-l-2 border-[#fe6b00] pl-3">
                  <div className="font-mono text-xl lg:text-2xl font-bold text-[#ffb693]">0.05 Sec</div>
                  <div className="text-xs text-[#8d90a0]">AI Stowage Bay Simulation</div>
                </div>
              </div>
            ...
            <div className="lg:col-span-6 bg-[#0e1c2f] p-4 lg:p-5 rounded-lg border border-[#434655]/30">
              <div className="flex justify-between items-center mb-3 pb-2 border-b border-[#434655]/30">
                <span className="font-mono text-xs text-[#b4c5ff] uppercase font-semibold">
                  BAY 42 CROSS-SECTION DENSITY MODEL
                </span>
        ...
        {activeTab === 'pillar3' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 bg-[#132033] border border-[#434655]/30 rounded-lg p-6 lg:p-8 items-center shadow-xl">
            <div className="lg:col-span-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="border-l-2 border-[#2563eb] pl-3">
                  ...
                  <div className="text-xs text-[#8d90a0]">Thermal Delta Accuracy</div>
                </div>
                <div className="border-l-2 border-emerald-400 pl-3">
                  <div className="font-mono text-xl lg:text-2xl font-bold text-emerald-400">100.0%</div>
                  <div className="text-xs text-[#8d90a0]">Cold Chain Integrity Rate</div>
                </div>
              </div>
              ...
              <div className="space-y-2.5 text-xs text-[#d6e3fe]">
                <div className="flex items-center space-x-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                  <span>Instant electronic certificate generation for customs food &amp; drug authorities</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
            ...
            <div className="lg:col-span-6 bg-[#0e1c2f] p-4 lg:p-5 rounded-lg border border-[#434655]/30">
              <div className="flex justify-between items-center mb-3 pb-2 border-b border-[#434655]/30">
                <span className="font-mono text-xs text-[#ffb693] uppercase font-semibold">
                  BIO-LOGISTICS ACTIVE AUDIT LOG
                </span>
                <span className="font-mono text-xs text-emerald-400 font-bold">CERTIFIED ISO 23412</span>
              </div>
        ...
        {activeTab === 'pillar4' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 bg-[#132033] border border-[#434655]/30 rounded-lg p-6 lg:p-8 items-center shadow-xl">
            <div className="lg:col-span-6">
              ...
              <p className="text-sm text-[#c3c6d7] leading-relaxed mb-6">
                국제해사기구(IMO) 탄소세 규제 및 EU ETS(배출권거래제)에 완벽 대응하는 18척의 차세대 친환경 자율운항 초대형 선단. 
                풍력 보조 로터 세일(Rotor Sail)과 하이드로포일 바이오 트리밍으로 화석연료 의존도를 영구히 탈피합니다.
              </p>

              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="border-l-2 border-emerald-400 pl-3">
                  <div className="font-mono text-xl lg:text-2xl font-bold text-emerald-400">-65.0%</div>
                  <div className="text-xs text-[#8d90a0]">Net Well-to-Wake Carbon</div>
                </div>
                <div className="border-l-2 border-[#2563eb] pl-3">
                  <div className="font-mono text-xl lg:text-2xl font-bold text-white">18 Vessels</div>
                  <div className="text-xs text-[#8d90a0]">Dual-Fuel Commissioned</div>
                </div>
              </div>
              ...
              <div className="space-y-2.5 text-xs text-[#d6e3fe]">
                <div className="flex items-center space-x-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                  <span>Certified green bunker agreements secured across Rotterdam, Busan &amp; Singapore</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                  <span>Real-time ESG emissions reporting integration with SAP &amp; Oracle Cloud ERP</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 bg-[#0e1c2f] p-4 lg:p-5 rounded-lg border border-[#434655]/30">
              <div className="flex justify-between items-center mb-3 pb-2 border-b border-[#434655]/30">
                ...
                <span className="font-mono text-xs text-[#b4c5ff] font-bold">PHASE 4 READY</span>
              </div>

...
export const RateSimulator: React.FC<RateSimulatorProps> = ({ onLockRateClick }) => {
  ...
  const handleSelectPlan = (planName: string, cost: number, days: number, carbon: number) => {
    ...
    setLockedNotice(`Locked Rate Applied: ${summary}. Transferred to RFP dispatch desk.`);
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-8">
          ...
          <p className="text-sm text-[#c3c6d7] mt-1">
            Compare live contract container spot rates, transit timelines, and Scope-3 maritime carbon emissions across key intercontinental trade lanes.
          </p>
        </div>
        ...
        <div className="bg-[#132033] border border-[#434655]/30 rounded-lg p-5 lg:p-8 shadow-xl">
          ...
          <div className="bg-[#0e1c2f] p-3.5 rounded border border-[#434655]/30 flex flex-col lg:flex-row justify-between items-center text-[#c3c6d7] font-mono text-xs gap-3">
            <div className="flex items-center space-x-2">
              ...
              <span>All ocean rates include BAF (Bunker Adjustment Factor) and IMO compliant low-sulfur bio-methanol credits.</span>
            </div>
            <div className="text-[#b4c5ff] font-semibold whitespace-nowrap">
              Instant B2B API Quote valid for 72 Hours
            </div>
          </div>
        </div>
      </div>

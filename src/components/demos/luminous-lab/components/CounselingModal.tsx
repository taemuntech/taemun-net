        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div className="p-3 bg-[#f1f3ff] rounded-xl text-[11px] text-[#3d4a42]">
              더마톨로지 전문 자문 연구원이 30분 이내에 등록된 계정(contact@taemun.co.kr)으로 1:1 맞춤 루틴 가이드를 회신드립니다.
            </div>
          ...
          <div className="py-8 text-center space-y-2">
            <CheckCircle2 className="w-12 h-12 text-[#006948] mx-auto animate-bounce" />
            <h4 className="text-base font-bold text-[#141b2b]">상담 접수가 완료되었습니다!</h4>
            <p className="text-xs text-[#3d4a42]">
              피부 전문가가 고객님의 피부 타입에 맞춘 솔루션을 빠르게 준비하여 답변드리겠습니다.
            </p>
          </div>
        )}
      </div>

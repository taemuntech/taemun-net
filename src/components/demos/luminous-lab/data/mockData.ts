...
export const HERO_PRODUCT = {
  ...
  clinicalStats: [
    { label: '피부 속수분 개선', value: '+240.8%' },
    { label: '손상 장벽 리페어', value: '89.4%' },
    { label: '피부 자극도 판정', value: '0.00 (무자극)' },
  ],
};
...
export const RANKING_PRODUCTS: Product[] = [
  {
    ...
    certifications: ['EWG ALL GREEN 1~2등급', '100% 이브 비건(EVE VEGAN)'],
  },
  {
    id: 'prod-2',
    rank: 2,
    ...
    skinConcern: ['장벽강화/보습'],
    certifications: ['EWG ALL GREEN 1~2등급', '인공향료·색소 무첨가'],
  },
  {
    id: 'prod-3',
    rank: 3,
    ...
    skinConcern: ['트러블/진정'],
    certifications: ['EWG ALL GREEN 1~2등급', '논코메도제닉 테스트 완료'],
  },
  {
    id: 'prod-4',
    rank: 4,
    ...
    certifications: ['EWG ALL GREEN 1~2등급'],
  },
];
...
export const SYNERGY_BUNDLE = {
  ...
  description: "속수분을 깊숙이 충전하는 '시카 엑소좀 앰플'과 겉수분을 샐 틈 없이 잠그는 '장벽 리페어 크림'을 함께 사용할 때 피부 수분 손실량(TEWL)이 42.8% 추가 감소합니다.",
...
export const REVIEWS: CustomerReview[] = [
  ...
  },
  {
    ...
    verifiedBadge: '화해 설문단 인증',
    rating: 5,
    comment: '"화해 어플 1위라길래 반신반의하면서 샀는데 전성분 1등급이라 그런지 눈시림이나 트러블 전혀 안 생겨요. 환절기마다 턱 쪽에 각질 일어났는데 장벽 크림이랑 같이 쓰니까 속당김 끝!"',
...
export const SKIN_COMPATIBILITY = [
  { type: '지성/트러블성 (피지 조절 및 진정)', percent: 100, label: '완벽 적합 (100%)' },
  { type: '민감성 피부 (저자극 판정)', percent: 99.8, label: '안전 적합 (99.8%)' },
  { type: '건성 피부 (속수분 채움)', percent: 97.4, label: '보습 적합 (97.4%)' },
];
...
export const CLINICAL_METRICS = [
  {
    ...
    percent: 98,
    value: '98%',
    desc: '단 1회 사용 직후 각질층 10층 속당김 완벽 개선',
    color: 'emerald',
  },
  {
    title: '흡수 밀착력 (잔여감 無)',
    percent: 96,
    value: '96%',
    desc: '워터-젤 텍스처로 끈적임 0.0% 산뜻한 마무리감',
    color: 'emerald',
  },
  {
    title: '피부온도 즉각 쿨링',
    percent: 90,
    value: '-4.5℃',
    desc: '열감에 의한 피부 붉은기 즉각 진정 효과 입증',
    color: 'secondary',
  },
  {
    title: '피부 자극 지수',

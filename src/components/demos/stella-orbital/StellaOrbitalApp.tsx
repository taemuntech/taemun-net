...
export default function StellaOrbitalApp({ isEmbed = false }: StellaOrbitalAppProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8f9ff] text-[#0b1c30] font-sans selection:bg-[#00288e] selection:text-white [&_h1]:break-keep [&_h2]:break-keep [&_h3]:break-keep">

  ...
  return (
    <header className="sticky top-[var(--sample-bar-h,0px)] z-40 bg-stone-900/90 backdrop-blur-md border-b border-stone-800 transition-all">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 h-20 flex items-center justify-between">
        {/* Logo */}
        <Link href="/demo/nouveau-dining" className="flex items-center gap-3 group">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-lg bg-amber-400 hover:bg-amber-300 text-stone-950 font-semibold text-xs lg:text-sm shadow-lg shadow-amber-500/20 transition-all active:scale-95 cursor-pointer"
          >
            F&B 공간 상담 신청
          </button>
        </div>

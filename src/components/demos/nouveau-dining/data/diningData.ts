...
export const DINING_ZONES: DiningZone[] = [
  ...
  },
  {
    ...
    features: [
      'STC 45 등급 차음 도어 및 리브드 우드 흡음재 (예시 규격)',
    ...
    hotspots: [
      ...
      },
      {
        ...
        desc: '금빛 결이 물결처럼 흐르는 천연 대리석 상판',
      },
      {
        x: 82,
        y: 45,
        title: '음향 차음 리브드 패널',
        desc: '대화의 명료도를 높이고 외부 소음이 새어 드는 것을 줄이는 패널',
      },
    ],
  },
];
...
export const DINING_MATERIALS: DiningMaterial[] = [
  {
    ...
    desc: '천연 비앙코 대리석 칩을 고밀도로 배합해 견고하게 연마한 천연 테라조입니다. 스크래치와 오염에 강해 고급 다이닝 카운터 상판에 즐겨 쓰입니다.',
  ...
  },
  {
    ...
    desc: '표백하지 않은 자연 본연의 에크루 미색을 머금은, 혼방 없이 짠 천연 린넨 패브릭입니다. 소음을 부드럽게 흡수하고 공간에 온화한 온도를 불어넣습니다.',

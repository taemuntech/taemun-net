  ...
  return (
    <header className="sticky top-[var(--sample-bar-h,0px)] z-40 bg-[#faf7f2]/90 backdrop-blur-md border-b border-[#ebdcd0] transition-all">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 h-20 flex items-center justify-between">
        {/* Logo */}
        <Link href="/demo/arche-wellness" className="flex items-center gap-3 group">
        ...
        <nav className="hidden lg:flex items-center gap-8 text-sm font-medium text-[#6e5d50]">
          ...
          <a href="#philosophy" className="hover:text-[#d27952] transition-colors">
            공간 힐링 철학
          </a>
        </nav>
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={onOpenTrial}
            className="px-4 py-2.5 rounded-lg bg-[#d27952] hover:bg-[#b8613d] text-white font-semibold text-xs lg:text-sm shadow-md shadow-[#d27952]/20 transition-all active:scale-95 cursor-pointer"
          >
            웰니스 스튜디오 시공 상담
          </button>
        </div>

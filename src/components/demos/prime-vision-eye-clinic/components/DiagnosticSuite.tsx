      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="max-w-3xl mb-12">
          ...
          <p className="font-body-lg text-[15px] lg:text-[17px] text-on-surface-variant mt-2 leading-relaxed">
            {language === 'KR'
              ? '단 1%의 부작용 가능성도 사전에 차단하기 위해, 대학병원급 첨단 진단 장비 4종을 크로스체크합니다.'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {devices.map((dev, idx) => (
            <div
              key={idx}
            ...
            >
              <div>
                ...
                <p className="font-body-sm text-[13px] text-on-surface-variant mt-3 leading-relaxed">{dev.desc}</p>
              </div>
        ...
        <div className="bg-gradient-to-r from-primary to-secondary text-on-primary rounded-2xl p-6 lg:p-8 shadow-xl flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h4 className="font-headline-lg text-[20px] lg:text-[24px] font-bold">

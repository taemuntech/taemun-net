      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 mb-6">
        <div>
          <span className="text-secondary text-xs font-mono font-bold flex items-center gap-1 mb-1">
            ...
            MICHELIN CHEF'S RECIPE ARCHIVE
          </span>
          <h2 className="text-xl lg:text-3xl font-bold text-primary">
            미슐랭 셰프의 지중해식 로스트 한우 채끝 &amp; 구운 토마토 타르타르
          </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div className="lg:col-span-5 relative rounded-xl overflow-hidden shadow-sm aspect-[4/3] bg-surface-container">
          <img
            ...
            alt="미슐랭 셰프의 지중해식 로스트 한우 채끝 & 구운 토마토 타르타르"
          ...
          <div className="absolute bottom-3 left-3 right-3 bg-surface-container-lowest/90 backdrop-blur p-3 rounded-lg border border-outline-variant flex items-center justify-between">
            <span className="text-xs font-bold text-primary">셰프 권우성 감수 꿀팁</span>

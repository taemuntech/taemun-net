          ...
          <div>
            ...
            <div className="space-y-2.5 mb-6">
              <div className="flex items-center gap-3 p-2.5 bg-surface-container-low rounded-lg border border-outline-variant">
                ...
                <div>
                  <div className="text-xs font-bold text-primary">샛별배송 100% 도착 보장제</div>
              ...
              <div className="flex items-center gap-3 p-2.5 bg-surface-container-low rounded-lg border border-outline-variant">
                ...
                <div>
                  <div className="text-xs font-bold text-primary">100% 생분해 워터아이스팩 &amp; 종이박스</div>
                  <div className="text-[12px] text-on-surface-variant">플라스틱 제로, 순수 물 100%와 재활용 골판지만 사용합니다.</div>
                </div>
              </div>
            </div>
          </div>

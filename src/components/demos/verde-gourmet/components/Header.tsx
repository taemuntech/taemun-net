...
export const Header: React.FC<HeaderProps> = ({
  ...
  const quickPills = [
    ...
    { name: '미슐랭 RMR 간편식', icon: 'soup_kitchen' }
  ];
      ...
      <div className="bg-surface-container-low border-b border-outline-variant text-[13px] text-on-surface-variant">
        <div className="max-w-7xl mx-auto px-4 lg:px-12 py-1.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-xs font-sans">
            ...
            <span className="text-on-surface-variant">고객센터 1644-8920</span>
            <span className="text-outline-variant">·</span>
            <button onClick={() => alert('베르데 고메 회원 로그인 서비스 준비 중입니다. 비회원으로도 샛별배송 주문이 가능합니다.')} className="cursor-pointer hover:text-primary font-medium text-primary">
              로그인 / 회원가입
            </button>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between py-3 gap-4">
            ...
            <div className="flex items-center gap-2 lg:gap-3 flex-shrink-0">
              ...
              >
                ...
                <span className="max-w-[140px] truncate font-medium">서울 용산구 한남대로</span>

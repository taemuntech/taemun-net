...
export const AddressModal: React.FC<AddressModalProps> = ({
  ...
  const popularAddresses = [
    { name: '서울 용산구 한남대로 98 (베르데빌딩)', isDawn: true },
    { name: '서울 성동구 아차산로 17 (성수 아티장길)', isDawn: true },
    { name: '서울 강남구 압구정로 142', isDawn: true },
    { name: '경기도 성남시 분당구 판교역로 146', isDawn: true },
    { name: '부산 해운대구 마린시티2로 33', isDawn: false }
  ];
        ...
        <div className="relative w-full max-w-lg bg-surface-container-lowest rounded-2xl shadow-2xl border border-outline-variant overflow-hidden p-6 space-y-5">
          <div className="flex items-center justify-between pb-3 border-b border-outline-variant">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-bold text-primary">샛별배송 지역 조회</h3>
            </div>
            <button
              onClick={onClose}

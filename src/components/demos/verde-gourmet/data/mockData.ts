...
export const PRODUCTS: Product[] = [
  {
    ...
    traceabilityNumber: '002194820192',
    producer: '농협안성축산물공판장 엄선 한우 명가',
  ...
  },
  {
    ...
    traceabilityNumber: 'ECO-2026-JEJU-09',
    producer: '제주 구좌 송당 친환경 농업공동체',
  ...
  },
  {
    ...
    traceabilityNumber: 'NOR-OSL-2026-0819',
    producer: 'SalMar Fjord Superior Selected',
    storageType: '냉장보관 (0~2℃)',
    packaging: '무빙 빙장 에어실링 포장'
  },
  {
    id: 'prod-sourdough-4',
    name: '르방 천연발효 깜파뉴 사워도우 & 이즈니버터 500g',
    ...
    category: 'bakery',
    description: '프랑스 전통 르방 스타터를 사용해 72시간 저온 자연발효한 깜파뉴. 겉은 바삭하고 속은 촉촉하며, 프랑스 AOP 이즈니 버터가 동봉됩니다.',
    traceabilityNumber: 'ARTISAN-BAKE-72H',
    producer: '성수 아티장 브레드 랩',
...
export const RECIPE_INGREDIENTS: RecipeIngredient[] = [
  ...
  {
    id: 'rec-ing-3',
    name: '이탈리아 파르미지아노 레지아노 24개월 숙성 100g',
    subtext: 'DOP 인증 깊은 감칠맛의 치즈',
    price: 7200,
    checked: true
  },
  {
...
export const QUICK_PILLS = [
  ...
  { name: '미슐랭 RMR 간편식', icon: 'soup_kitchen', active: false, categoryId: 'meat' }
];

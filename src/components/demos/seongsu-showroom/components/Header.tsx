    ...
    <header className="sticky top-[var(--sample-bar-h,0px)] z-40 w-full bg-[#121316]/90 backdrop-blur-md border-b border-white/10 text-white transition-all">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => handleNavClick('hero')}>
          <div className="w-10 h-10 rounded-sm bg-stone-200 text-[#121316] flex items-center justify-center font-serif font-black text-xl tracking-tighter">
            AM
          </div>
          <div>
        ...
        <div className="lg:hidden bg-[#121316] border-b border-white/10 px-6 py-6 space-y-4 animate-in fade-in duration-200">
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full py-3 text-center rounded-sm bg-amber-500 hover:bg-amber-400 text-stone-950 font-bold text-xs tracking-widest uppercase"
            >
              프로젝트 1:1 상담 예약
            </button>
          </div>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 relative aspect-16/10 rounded-2xl overflow-hidden border border-[#382f29] bg-[#14110f] shadow-2xl group">
            ...
            {currentZone.hotspots.map((spot, idx) => {
              ...
              return (
                ...
                >
                  <button
                    ...
                    className={`relative w-8 h-8 rounded-full flex items-center justify-center transition-all cursor-pointer ${
                      isSelected
                        ...
                        : 'bg-[#1f1915]/90 hover:bg-[#d8b896] text-[#f4ede2] hover:text-[#1f1915] border border-[#d8b896]/60 shadow-md'
                    }`}
                  >
                  ...
                  {/* Tooltip */}
                  {isSelected && (
                    <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-3 w-60 p-3.5 rounded-xl bg-[#1c1714]/95 border border-[#6b5545] shadow-2xl backdrop-blur-md text-left z-30 pointer-events-none text-[#f4ede2]">
            ...
            <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-[#1c1714]/90 backdrop-blur-md border border-[#382f29]">
              ...
              <p className="text-xs lg:text-sm text-[#ddd2c5] line-clamp-2">
          ...
          <div className="lg:col-span-4 p-6 lg:p-8 rounded-2xl bg-[#181310] border border-[#382f29] shadow-xl">
            ...
            <p className="text-xs text-[#b39274] font-medium mb-6">{currentZone.subtitle}</p>

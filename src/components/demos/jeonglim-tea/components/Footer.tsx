      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
          ...
          <div className="lg:col-span-6">
            ...
            <p className="text-xs text-[#a89888] leading-relaxed max-w-md font-light mb-4">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <a href="#zones" className="hover:text-[#f4ede2] transition-colors">
                  한옥 3대 다도 공간
                </a>
              </li>
              <li>
                <a href="#pairing" className="hover:text-[#f4ede2] transition-colors">
                  날씨 & 차 앰비언스 HUD
                </a>
              </li>
              <li>
                <a href="#materials" className="hover:text-[#f4ede2] transition-colors">
                  전통 고재 자재 아카이브
                </a>
              </li>
            </ul>
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-xs text-[#a89888] mb-3 leading-relaxed">
              본 포트폴리오 사이트와 동일한 수준의 한옥·다도 문화 맞춤형 웹사이트 제작을 원하시면 문의해 주세요.
            </p>
            <Link
              href="/inquiry?from=jeonglim-tea"
              className="inline-block px-4 py-2 rounded-lg bg-[#6b5545]/20 hover:bg-[#6b5545]/30 text-[#d8b896] border border-[#6b5545]/40 text-xs font-semibold transition-all"
            >

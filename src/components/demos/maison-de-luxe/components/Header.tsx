...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="w-full py-2 border-b border-[#4d4635] bg-[#0e0e0e] relative z-40">
      {/* 배경·아래 구분선은 화면 끝까지, 안쪽 줄은 1280(max-w-7xl) 안 — 좌우 여백도 안쪽에 둬서 본문 구역들과 글자 선을 맞춘다 */}
      <div className="max-w-7xl mx-auto px-4 lg:px-16 flex flex-col gap-2">

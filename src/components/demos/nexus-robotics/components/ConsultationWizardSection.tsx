...
interface ConsultationWizardSectionProps {
 onSubmitSuccess: (name: string) => void;
}

export function ConsultationWizardSection({ onSubmitSuccess }: ConsultationWizardSectionProps) {
 ...
 e.preventDefault();
 onSubmitSuccess(formData.contactName || '고객');
 setFormData({
 fabEnv: 'semi',
 targetProcess: '',
 dailyVolume: '',

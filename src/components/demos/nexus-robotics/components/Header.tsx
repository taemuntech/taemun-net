...
export function Header({ onOpenDocModal }: HeaderProps) {
 ...
 <div className="flex justify-between items-center gap-3 w-full px-4 lg:px-12 h-16 max-w-7xl mx-auto">
 {/* Brand Logo — #top 은 히어로 섹션(실재 앵커)이다 */}
 <a href="#top" className="flex items-center gap-2.5 lg:gap-3 group min-h-11 shrink-0">
 ...
 <span className="text-[13px] lg:text-sm tracking-tight text-slate-900 font-bold uppercase whitespace-nowrap">
 NEXUS ROBOTICS
 </span>
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1.5 h-9 min-h-9 lg:min-h-11 lg:px-4 lg:py-2.5 rounded-md bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 text-xs font-semibold transition-colors shadow-sm whitespace-nowrap"
 >
 <span className="hidden lg:inline">도입 ROI 맞춤 상담</span>
 ...
 className="h-9 w-9 lg:h-11 lg:w-11 -mr-1 lg:-mr-2 flex items-center justify-center rounded lg:hidden text-slate-600 hover:bg-slate-100 cursor-pointer"
 aria-label="메뉴 열기/닫기"

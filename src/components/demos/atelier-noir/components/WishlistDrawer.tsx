    ...
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm" onClick={onClose}>
      ...
      >
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-start">
                        ...
                        <button
                          ...
                          className="text-[#8f9378] hover:text-[#ffb4ab] text-xs"
                        >
                          ✕
                        </button>
                      </div>
                      <div
                        ...
                        className="text-[#ffffff] font-bold text-xs line-clamp-1 cursor-pointer hover:text-[#caf300]"
                      >
                        {product.name}
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center mt-2 pt-1">
                      ...
                      <button
                        ...
                        className="bg-[#caf300] text-[#171e00] px-2.5 py-1 text-[11px] font-bold uppercase hover:bg-[#ffffff]"
                      >
                        담기
                      </button>
                    </div>
        ...
        <div className="pt-4 hairline-t">
          <button
            onClick={onClose}
            className="w-full py-3 bg-[#1f2021] hover:bg-[#292a2b] text-[#ffffff] font-label-sm text-xs tracking-wider uppercase transition-colors"
          >
            쇼핑 계속하기
          </button>
        </div>

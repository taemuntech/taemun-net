      ...
      <div className="relative w-full max-w-lg bg-white border border-[#E8E2D9] rounded-3xl p-6 lg:p-8 text-[#2D2A26] shadow-2xl">
        ...
        {submitted ? (
          <div className="text-center py-8">
            <div className="w-16 h-16 rounded-full bg-[#FDF0EC] text-[#E07A5F] text-3xl flex items-center justify-center mx-auto mb-4 font-bold">
              ✓
            </div>
            <h3 className="text-2xl font-serif font-bold text-[#2D2A26] mb-2">
              원데이 체험 신청이 접수되었습니다
            </h3>
            <p className="text-xs text-[#5C554D] leading-relaxed mb-6">
              남겨주신 학부모님 연락처로 아뜰리에 원장단이 준비물 및 원탁 클래스 배정 안내를 유선으로 드리겠습니다. (본 화면은 가상 샘플 데모로 실제 전송되지 않습니다)
            </p>
            <button
              type="button"
              onClick={handleReset}
              className="px-6 py-3 rounded-full bg-[#E07A5F] text-white font-semibold text-xs hover:bg-[#c9684f] min-h-[44px]"
            >
              확인
            </button>
          </div>

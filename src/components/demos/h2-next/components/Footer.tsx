          ...
          <div className="lg:col-span-8 grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs lg:text-sm text-[#3d4947]">
                ...
                <li><a className="hover:text-[#00685f] transition-colors" href="#governance">분기/결산 재무제표 (예시)</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs lg:text-sm text-[#3d4947]">
                ...
                <li><a className="hover:text-[#00685f] transition-colors" href="#calculator">배출권 산출기</a></li>
                <li><a className="hover:text-[#00685f] transition-colors" href="#consultation">EPC 기술 제휴</a></li>
                <li><a className="hover:text-[#00685f] transition-colors" href="mailto:hello@example.com">IR 투자자 미팅 접수</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="pt-6 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 text-xs ] text-[#6d7a77]">
          <div className="space-y-1">
            ...
            <p className="font-mono text-[11px] pt-1">
              © 2025 H2 NEXT Energy Systems Inc. All rights reserved. 인증 표기 자리 (예시).
            </p>

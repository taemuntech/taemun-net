    ...
    >
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto w-full px-4 lg:px-12 pt-12 pb-8 flex flex-col justify-center flex-grow">
        <div className="max-w-3xl">
          ...
          <div
            id="hero-status-pill"
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/90 border border-[#00685f]/20 backdrop-blur-md shadow-xs mb-4 max-w-full"
          >
          ...
          <h1
            ...
            className="text-3xl lg:text-[54px] font-bold tracking-tight text-[#0b1c30] mb-5 leading-[1.18] drop-shadow-xs [word-break:keep-all]"
          >
            바람과 물에서 시작되는<br />
            무한한 청정에너지의 새로운 시대
          </h1>
          ...
          <p
            id="hero-subtitle"
            className="text-base lg:text-lg text-[#3d4947] max-w-2xl mb-8 font-normal leading-relaxed [word-break:keep-all]"
          >
            기가와트(GW)급 해상풍력 연계 고효율 PEM 수전해 플랜트부터 영하 253도 액화수소 글로벌 밸류체인까지. 지속 가능한 산업 생태계를 위한 넷제로 에너지 엔지니어링을 다룹니다.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3 mb-8">
            <a
              ...
              className="inline-flex min-h-11 items-center justify-center gap-2 bg-[#00685f] hover:bg-[#008378] text-white text-base font-semibold px-6 py-3.5 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 active:scale-95 text-center"
              href="#consultation"
            >
              <span className="[word-break:keep-all]">사업 제휴 및 PPA 계약 제안서</span>
            ...
            <button
              ...
              className="inline-flex min-h-11 items-center justify-center gap-2 bg-white/90 hover:bg-[#eff4ff] text-[#00685f] border border-[#bcc9c6]/50 text-base font-semibold px-6 py-3.5 rounded-lg backdrop-blur-md shadow-xs hover:border-[#00685f]/40 transition-all duration-200 cursor-pointer text-center"
            >
              <PlayCircle className="w-5 h-5 text-[#006398] flex-shrink-0" />
              <span className="[word-break:keep-all]">서남해 1.2GW 해상풍력 현장 영상</span>
            </button>
          </div>
        </div>
      </div>

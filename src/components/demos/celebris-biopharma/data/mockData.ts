...
export const TRUST_METRICS = [
  ...
  },
  {
    ...
    value: "4종 임상",
    subtext: "FDA / MFDS 글로벌 IND 승인 및 진행",
...
export const PIPELINE_DATA: PipelineItem[] = [
  {
    ...
    highlightStatus: "FDA 희귀의약품(ODD) 지정 완료",
...
export const SAB_ADVISORS: SabAdvisor[] = [
  {
    ...
    affiliation: "서울대 의대 암연구소 석좌교수",
    bio: "30여 년간 난치성 폐암 및 RAS 단백질 변이 기전을 규명한 글로벌 종양학 권위자. 다수의 글로벌 임상시험 PI 및 대한암학회 이사장 역임.",
  ...
  },
  {
    ...
    affiliation: "존스홉킨스 의대 종양내과학 주임교수",
    bio: "미국 FDA 항암제 자문위원(ODAC) 역임 및 다중특이성 항체-약물 접합체(ADC) 초기 임상 프로토콜 설계의 최고 권위자.",
    specialty: "Specialty: FDA Regulatory & ADC Clinical Trial Design",
  ...
  },
  {
    ...
    affiliation: "MIT-하버드 브로드 연구소 출신",
...
export const PUBLICATIONS: Publication[] = [
  {
    ...
    year: "2025",
    doi: "10.1038/s41591-025-03120-x",
    ...
    filePdfName: "Nature_Medicine_2025_CB101_Full_Paper.pdf"
  },
  {
    journal: "Cancer Discovery (2024)",
    year: "2024",
    doi: "10.1158/2159-8290.CD-24-0412",
    ...
    filePdfName: "Cancer_Discovery_2024_Trop2_ADC_Paper.pdf"
  }
];

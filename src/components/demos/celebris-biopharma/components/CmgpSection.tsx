...
export const CmgpSection: React.FC = () => {
  return (
    <section className="py-24 bg-white border-t border-[#c4c5d5]/30" id="infrastructure">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-[16px] text-[#444653] leading-relaxed">
              임상 물질의 글로벌 직접 생산과 규제기관(FDA, EMA) 무균 밸리데이션 요건을 충족하는 최첨단 싱글유즈(Single-Use) 바이오리액터 및 고도화 분석 장비를 완비했습니다.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start space-x-4 p-4 rounded-xl bg-[#eff4ff]/70 border border-[#c4c5d5]/30">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-[#444653] mt-1 leading-relaxed">
                    교차 오염율 0.00%의 무균 세포 배양 라인 4기를 병렬 운영하여 임상 1~3상 완제품을 유연하게 생산합니다.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 p-4 rounded-xl bg-[#eff4ff]/70 border border-[#c4c5d5]/30">
                ...
                <div>
                  <h4 className="text-[16px] font-bold text-[#0b1c30]">
                    LC-MS/MS Orbitrap 질량분석기 12기
                  </h4>
                  <p className="text-[13px] text-[#444653] mt-1 leading-relaxed">
                    초고분해능 단백질 구조 분석 및 ADC 약물-항체 비율(DAR)의 정량적 모니터링을 실시간 지원합니다.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 p-4 rounded-xl bg-[#eff4ff]/70 border border-[#c4c5d5]/30">
                ...
                <div>
                  <h4 className="text-[16px] font-bold text-[#0b1c30]">
                    FDA cGMP & EMA Annex 1 적격 인증
                  </h4>
                  <p className="text-[13px] text-[#444653] mt-1 leading-relaxed">
                    미국 FDA와 유럽 의약품청 가이드라인을 완전 충족하는 ISO 5 등급 무균 클린룸 시설을 운영 중입니다.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="relative rounded-xl overflow-hidden border border-[#c4c5d5]/40 shadow-sm bg-white lg:col-span-2 group">
                <img
              ...
              <div className="p-6 rounded-xl bg-[#eff4ff]/60 border border-[#c4c5d5]/30 hover:bg-[#eff4ff] transition-colors">
                ...
                <p className="text-[13px] text-[#444653] mt-2 leading-relaxed">
                  고순도 표적 단백질 합성 및 균일 정제 재현성 데이터 35회 연속 달성
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl bg-[#eff4ff]/60 border border-[#c4c5d5]/30 hover:bg-[#eff4ff] transition-colors">
                ...
                <p className="text-[13px] text-[#444653] mt-2 leading-relaxed">
                  글로벌 탑티어 제약사 3개사 대상 현장 CMC 실사 결함 0건 통과
                </p>
              </div>
            </div>
          </div>

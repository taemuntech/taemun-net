      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-16">
        ...
        <div id="hero-metrics-ribbon" className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 mt-8 pt-8 border-t border-[#c8c7bf]/30">
          <div className="p-5 bg-[#f4f3f1] rounded-xs border border-[#c8c7bf]/20 hover:border-[#c8c7bf]/60 transition-colors">
            ...
            <p className="text-xs lg:text-sm text-[#1a1c1b] font-semibold mb-0.5">도편수 목수단 (예시)</p>
          ...
          <div className="p-5 bg-[#f4f3f1] rounded-xs border border-[#c8c7bf]/20 hover:border-[#c8c7bf]/60 transition-colors">
            ...
            <p className="text-xs lg:text-sm text-[#1a1c1b] font-semibold mb-0.5">전국 고급 한옥 완공 (예시)</p>
          ...
          <div className="p-5 bg-[#f4f3f1] rounded-xs border border-[#c8c7bf]/20 hover:border-[#c8c7bf]/60 transition-colors">
            ...
            <p className="text-xs lg:text-sm text-[#1a1c1b] font-semibold mb-0.5">패시브급 단열 성능 (예시)</p>
            <p className="text-[11px] lg:text-xs text-[#777770]">독일식 로이 3중 시스템 창호 및 기밀벽체</p>
          </div>

          <div className="p-5 bg-[#f4f3f1] rounded-xs border border-[#c8c7bf]/20 hover:border-[#c8c7bf]/60 transition-colors">
            <div className="font-serif text-2xl lg:text-3xl text-[#161714] tracking-tight mb-1">
              15%↓ <span className="text-sm font-sans text-[#474741] font-normal">함수율</span>
            </div>
            <p className="text-xs lg:text-sm text-[#1a1c1b] font-semibold mb-0.5">자연 건조목 (예시)</p>

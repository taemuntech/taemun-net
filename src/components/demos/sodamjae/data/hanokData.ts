...
export const HERO_FEATURED_PROJECT: Project = {
  ...
  detailedStory: '북한강의 유려한 물결과 서종의 솔숲을 조망하는 대지에 지어진 담솔헌은 대청마루 전면을 대형 3중 로이 단열 통창으로 구성하여 사계절의 파노라마 차경을 집안 가득 끌어들였습니다. 강원도 태백산맥 80년생 금강송을 7년간 음지 자연 건조하여 목재의 뒤틀림을 0%에 수렴하도록 가공했으며, 독일식 패시브 기밀공법과 지열 냉난방을 채택해 겨울철 난방비 65% 절감(예시 수치)을 목표로 설계했습니다.',
  imageUrl: HERO_IMAGE_URL,
  tags: ['북한강 차경', '금강송 육송', '지열 히트펌프', '3중 로이창호', '사개맞춤'],
  specs: {
    wood: '강원도 태백산 금강송 (함수율 12%, 예시)',
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    detailedStory: '서울 북촌 한옥 보존지구의 엄격한 건축 심의를 통과하며 기존 100년 목재 고재를 정밀 해체 복원했습니다. 지상은 단아한 전통 팔작 기와지붕과 누마루의 고즈넉함을 살리고, 지하 암반 절토면에는 현대식 음향 설비를 갖춘 홈시네마 및 항온항습 와인셀러를 배치하여 도심 주거의 새로운 패러다임을 열었습니다.',
  ...
  },
  {
    ...
    detailedStory: '제주도의 거센 해풍과 염분에 대비해 특수 천연 옻칠 및 고내후성 스테인 마감을 적용한 별서입니다. 제주 전통 가옥의 밭담 및 안거리·밖거리 구조를 재해석하여, 바다를 조망하는 노천 편백나무 히노키탕과 자연석 바닥 마감을 통해 도심을 벗어난 온전한 쉼을 선사합니다.',
...
export const ENGINEERING_FEATURES: EngineeringFeature[] = [
  ...
  },
  {
    ...
    description: '벽체 및 천장 내부 미세 온습도·연기 감지 IoT 센서와 열회수 환기장치(ERV)가 연동되어 365일 실내 공기질과 화재 안전을 관리합니다.',
    iconName: 'cpu'
  }
];
...
export const ROADMAP_STEPS: RoadmapStep[] = [
  ...
  },
  {
    step: 'STEP 02',
    title: '맞춤형 3D 가상 설계',
    description: '건축주 가족의 라이프스타일을 반영한 동선 설계. 마당, 대청, 입식 주방 및 가구 배치를 실제 크기에 맞춘 3D 가상 모델링으로 사전 확인합니다.',
    duration: '소요 기간: 4~6주'
  },
  {
    step: 'STEP 03',
    title: '원목 엄선 및 정밀 치목',
    description: '함수율 15% 이하(예시) 건조 육송을 선별하여 소담재 전용 양평 공방에서 도편수의 지휘 아래 기둥과 보를 깎고 다듬는 수작업 치목을 완료합니다.',
  ...
  {
    step: 'STEP 05',
    title: '준공 및 10년 케어 (예시)',
    description: '건축물 준공 검사 후 입주 점검. 계절 변화에 따른 목재의 자연스러운 수축 팽창 모니터링과 천연 오일 스테인 보수를 10년간 이어 갑니다(예시).',
    duration: '10년 정기 점검 (예시)'
  }
];

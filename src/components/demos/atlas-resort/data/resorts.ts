...
export const VILLAS: Villa[] = [
  {
    ...
    description: '남해 60미터 해안 암벽 위에 얹힌 미니멀리스틱 석재 파빌리온. 180도 파노라마 오션뷰와 완벽한 소음 차단 음향 설계를 자랑합니다.',
    specs: {
      suite: '2 침실 (킹사이즈)',
      pool: '18m 온수 해수풀',
...
export const ADDONS: AddOnOption[] = [
  ...
  {
    id: 'addon-dinner',
    title: '미쉐린 스타 셰프 인빌라 테이스팅 디너 & 소믈리에 페어링',
    price: 850000,
    defaultChecked: true,
  },
  {
...
export const PILLARS: ExperiencePillar[] = [
  {
    ...
    alt: 'Exquisite minimalist Michelin fine dining plate in luxury resort',
  },
  {
    id: 'wellness',

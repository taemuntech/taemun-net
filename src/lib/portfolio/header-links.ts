...
export const HEADER_DEMO_LINKS: readonly HeaderDemoLink[] = [
  ...
  },
  {
    ...
    mobileDescription: "반도체 쿼츠웨어 제안 시안",
    tone: "blue",
    iconKey: "globe",
  },
  {
    ...
    label: "아뜰리에 보클루즈",
    badge: "DEMO",
    description: "하이엔드 건축·인테리어 스튜디오 샘플 사이트",
    mobileDescription: "건축·인테리어 스튜디오 샘플",
    tone: "amber",
    iconKey: "compass",
  },
  {
  ...
  },
  {
    ...
    badge: "메디컬 02",
    description: "소모품 번호 조회 & 1인 프라이빗 안티에이징",
    mobileDescription: "소모품 번호 조회 & 1인실 안티에이징 데모",
    tone: "emerald",
    iconKey: "sparkles",
  },
  {
  ...
  },
  {
    ...
    badge: "메디컬 05",
    description: "의·한의 협진 80병상 입원 한방병원",
    mobileDescription: "한방병원 입원·재활 안내 데모",
    tone: "emerald",
    iconKey: "sparkles",
  },
  {
  ...
  },
  {
    ...
    mobileDescription: "반도체 FA 장비 & 가스 시스템 제안 시안",
    tone: "cyan",
    iconKey: "cpu",
  },
  {

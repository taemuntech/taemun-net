...
export const GALLERY_CATEGORIES: GalleryCategoryMeta[] = [
  ...
  },
  {
    ...
    description: '의료진의 학술 전문성과 임상 신뢰도를 극대화하고, 온라인 예약 화면과 비급여 항목 수가 공개로 신환 내원을 촉진하는 전문 클리닉 솔루션입니다.',
    badge: '임상 신뢰 · 신환 유치',
  },
  {
    id: 'interior',
...
export const GALLERY_PROJECTS: GalleryProject[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      '의료용 항균 규조 미장, 천연 트래버틴, 샴페인 골드 자재 아카이브',
  ...
  },
  {
    ...
    highlights: [
      ...
      '용적률·일조사선 최적화로 임대 면적을 극대화하는 정밀 상업 공간 설계',
  ...
  },
  {
    ...
    highlights: [
      ...
      '초고압 제트 그라우팅(JSP) 차수 및 지반 자동 계측 관제 시스템',
  ...
  },
  {
    ...
    summary: '밀스펙 러기드 감리 패드 UI & 0% 터파기부터 100% 준공까지 4단계 건축 공정 타임랩스 빌드업',
  ...
  },
  {
    ...
    highlights: [
      ...
      '실시간 1~8위 랭킹 차트(예시 수치) 및 앰플+장벽크림 시너지 번들 특가 담기',
  ...
  },
  {
    ...
    summary: '파라메트릭 정밀 하드웨어 스펙 비교 매트릭스, 3D 쿨링 챔버 분해도 뷰어, 섀시 I/O 포트 텔레메트리 맵 및 실시간 벤치마크 엔진',
  ...
  },
  {
    ...
    thumbnailUrl: '/demo-media/aerospect-dynamics/desktop.png',
    liveDemoUrl: '/demo/aerospect-dynamics',
    techStack: ['Next.js 16', 'React 19', 'Tailwind CSS v4', 'TypeScript'],
    period: '2주',
    year: '2026',
    highlights: [
      '4K 초고해상도 광학 RGB & 방사열 열화상 실시간 스플릿 드래그 비교 뷰어',
      '0.1mm 미세 크랙 AI 자동 판독 및 공인 기준 결함도 등급 채점 콘솔',
      '3D 라이다 포인트 클라우드 기반 디지털 트윈 & 토공량(Cut & Fill) 산출기',
      '24/7 BVLOS 원격 출격·충전 기상 레이더 연동 센티넬 도크 시뮬레이터',
    ],
  },
  {
  ...
  },
  {
    ...
    client: '순우리말 자연미 & 안면 황금비율 중점 성형외과',
    category: 'medical',
    categoryName: '병의원 · 성형외과/안면윤곽',
    summary: '1:1:0.8 안면 황금비율 시뮬레이터, Before & After 듀얼 슬라이더 & 5대 안심안전망',
    ...
    highlights: [
      ...
      '대리수술 0% 실명 집도의제·마취과 1:1 상주·보호자 안심 CCTV 등 5대 안전망 인증',
      '고압산소 챔버 치료 및 힐라이트 II 스마트 광선 케어 기반 1인 VIP 붓기 힐링 라운지',
    ],
  },
  // ─── 08. 학원 · 교육 (Education & Elite Academy) ──────────────────
  {
    ...
    description: '대치동 최상위권 수험생을 위한 의치약학 계열 전문 입시학원 공식 웹사이트입니다. 국·수·탐 백분위 조절 기반 전국 의치약한 모의 합격진단 시뮬레이터, 평가원 수능 킬러문항 3단계 핀셋 해체 인터랙티브 Lab, 4계절 12주(예시) 의대 커리큘럼 로드맵, 1:1 심층 입학 진단 레벨테스트 신청 위저드를 제공합니다.',
    ...
    highlights: [
      ...
      '고1~N수 4계절 12주 완성(예시) 의대 집중 커리큘럼 로드맵 & 주간 클리닉 시스템',
      '지망 학과 및 목표 전형별 1:1 입학 진단 레벨테스트 신청 위저드 & 원장단 직통 상담',
    ],
  },
  {
    id: 'chopin-piano',
    ...
    summary: 'Web Audio API 88건반 실시간 배음 합성 & 스타인웨이 D-274 잔향 스펙트럼 HUD',
    ...
    highlights: [
      ...
      '예원·선화 예중·예고 및 독일·오스트리아 국립음대 유학 1:1 도제식 마스터클래스 로드맵',
      '지망 목표별 1:1 실기 심사 및 스타인웨이 콘서트 살롱 청강 신청 위저드',
    ],
  },
  {
    id: 'atelier-kids',
    ...
    highlights: [
      ...
      '프랑스 에꼴 드 보자르 기반 4인 원탁 소수정예 4단계 미술 성장 로드맵',
      '연령 단계별 1회 무료 원데이 감각 체험 수업 신청 및 성향 진단 위저드',
    ],
  },
  {
    ...
    summary: '렉사일 200L~1100L 가상 서재 & AI 음성인식 스피킹 발음 진단 리포트',
  ...
  },
  {
    ...
    description: '아이비리그 공인 입시 전략 브로드시트 가제트 웹사이트입니다. Digital SAT 1600 적응형 시험 점수 시뮬레이터 및 Academic Index 텔레메트리 계산기, 전직 아이비리그 입학사정관의 Common App 에세이 3막 핀셋 해체 주석(Marginalia), 8대 명문대 입시 옥텟 롤 아카이브, 1:1 비공개 포트폴리오 감사 신청 위저드를 제공합니다.',
  ...
  },
  {
    ...
    summary: '1,000Hz 3D 관절 키네마틱스 분석 & 5대 실기 종목 만점 환산기 & 센서베이 진단 예약',
    description: '0.01초와 1cm를 지배하는 스포츠 바이오메카닉스 전문 교육기관 웹사이트 샘플입니다. 1,000Hz 광학 센서 기반 3D 관절 각도·지면반력 키네마틱스 분석, 주요 체대 및 경찰·소방 5대 실기 종목 만점 환산기, 엘리트 코칭스태프 아카이브, 1:1 센서베이 실기 정밀 진단 예약 위저드를 제공합니다.',
    ...
    highlights: [
      ...
      'S대 체육교육과 및 경찰·소방 특채 실기 합격생 계측 데이터베이스 아카이브(예시)',

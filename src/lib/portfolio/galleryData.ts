...
export const GALLERY_PROJECTS: GalleryProject[] = [
  ...
  // ─── 06. 기업 랜딩 (Corporate) ─────────────────────────────────
  {
    ...
    client: '시리즈 B 딥테크 반도체·2차전지 피지컬 AI 기업',
    category: 'corporate',
  ...
  },
  {
    ...
    description: '노르딕 클린테크 감성의 대형 신재생에너지 엔터프라이즈 플래그십 사이트입니다. 신안·울산·포항 4대 발전 거점 실시간 SCADA 텔레메트리 연동 맵, 기업용 연간 전력 사용량 기반 K-ETS 탄소 배출권 및 PPA 금융 절감 계산기, TÜV Rheinland 그린수소 인증관을 완비했습니다.',
    ...
    highlights: [
      ...
      'TÜV Rheinland 그린수소 인증 및 2025 지속가능경영보고서',
    ],
  },
  {
    ...
    badge: '실물 라이브 데모',
    highlights: [
      'CB-101 비소세포폐암 FDA ODD 지정 & 글로벌 임상 2상 트래커',

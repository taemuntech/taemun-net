...
export const GALLERY_PROJECTS: GalleryProject[] = [
  ...
  },
  {
    ...
    summary: '최상위 명품 카테고리 3단계 검수 이력 조회 화면(예시 · 공인 감정 아님), 실시간 NFC 시리얼 보증서 조회, 1:1 VIP 컨시어지 챗 및 안심 예치 결제 시스템',
  ...
  },
  {
    ...
    title: '아틀리에 보자르 미대입시 & 디자인 조형 랩',
    client: '가상 브랜드 샘플 — 실제 업체가 아닙니다 (명문 미대입시 아카데미 설정)',
    category: 'education',
    categoryName: '학원 · 명문 미대입시/조형랩',
    summary: '3D 원근 틸트 합격작 큐레이션 & 실기 기출 발문 핀셋 해체 Lab',
    description: 'S대 디자인, K대 조형대, H대, K-ARTS 등 최상위 명문 미대(예시) 실기 시험에 최적화된 전문 디자인 연구소 공식 웹사이트입니다. 마우스 인터랙티브 3D 원근 틸트 합격작 갤러리, 황금분할선 구도 오버레이, 기출문제 제시물 물성 핀셋 해체 Lab, 1:1 모의 실기 평가 신청 위저드를 제공합니다.',
    ...
    highlights: [
      ...
      'S대 통합실기·K대 기초조형(예시) 기출문제 제시물 물성 및 실기 전략 핀셋 해체 Lab',
  ...
  {
    id: 'royal-ballet',
    title: '로열 발레 아카데미 & 현대무용',
    client: '가상 브랜드 샘플 — 실제 업체가 아닙니다 (클래식 발레 아카데미 설정)',
    category: 'education',
    categoryName: '학원 · 클래식 발레/무용',
    summary: '발레 5대 포지션 180° 턴아웃 해부학 Lab & 바가노바 영재 입시',
    description: '러시아 바가노바와 영국 로열 발레단 정통 메소드 기반 클래식 무용 전문 교육기관 공식 웹사이트입니다. 발레 5대 기본 발 포지션 및 턴아웃 각도 조절 해부학적 인터랙티브 시뮬레이터, 예중·예고·해외 발레단 입시 로드맵, 전국 콩쿠르 수상작 갈라 아카이브, 1:1 체형 진단 오디션 신청 위저드를 제공합니다.',
    thumbnailUrl: '/portfolio/royal-ballet/desktop.png',
    liveDemoUrl: '/demo/royal-ballet',
    techStack: ['Next.js 16', 'React 19', 'Tailwind CSS v4', 'TypeScript', 'Ballet Turnout Simulator', 'Anatomy Biomechanics Lab'],
    period: '2주',
    year: '2026',
    badge: '실물 라이브 데모',
    highlights: [
      '발레 5대 기본 발 포지션(1번~5번) 및 턴아웃 각도 조절 해부학적 인터랙티브 시뮬레이터',
      '러시아 바가노바 & 영국 RAD 정통 메소드 기반 예중·예고·해외 발레단 입시 로드맵',
      '전국 무용 콩쿠르 대상 및 주요 예고 수석 합격생 솔로 바리에이션 공연 아카이브',
      '골반 가동성 및 발목 턴아웃 정렬을 실측하는 1:1 체형 진단 & 실기 오디션 신청 위저드',
    ],
  },
  {
  ...
  {
    id: 'vocal-recording',
    title: '보컬하우스 레코딩 스튜디오 & 실용음악',
    client: '가상 브랜드 샘플 — 실제 업체가 아닙니다 (보컬 스튜디오 & 아카데미 설정)',
    category: 'education',
    categoryName: '학원 · 실용음악/보컬레코딩',
    summary: 'Web Audio API 4트랙 실시간 DAW 파형 믹서 & C3-C6 건반 성구 진단기',
    description: '프로페셔널 실전 스튜디오 레코딩과 음향 물리학적 성구 전환(Passaggio) 발성 훈련을 결합한 차세대 실용음악 아카데미 공식 웹사이트입니다. Web Audio API 기반 4채널 멀티트랙 볼륨·Mute·Solo 믹서, 실시간 Canvas 주파수 스펙트럼 파형, C3~C6 피아노 건반 음역대 성구 인터랙티브 진단기, 1:1 보컬 오디션 레코딩 신청 위저드를 제공합니다.',
    thumbnailUrl: '/portfolio/vocal-recording/desktop.png',
    liveDemoUrl: '/demo/vocal-recording',
    techStack: ['Next.js 16', 'React 19', 'Tailwind CSS v4', 'TypeScript', 'Web Audio API DAW Mixer', 'HTML5 Canvas Waveform'],
    period: '2주',
    year: '2026',
    badge: '실물 라이브 데모',
    highlights: [
      'Web Audio API 기반 4트랙(보컬·피아노·베이스·드럼) 실시간 신디사이저 & DAW 믹서',
      'HTML5 Canvas 기반 실시간 다채널 주파수 스펙트럼 파형 비주얼라이저',
      'C3~C6 피아노 건반 클릭 사운드 피치 및 흉성·믹스·두성 성구 인터랙티브 진단',
      '지망 목표별(K-POP 오디션, 실용음악 입시) 1:1 보컬 진단 및 마이크 테스트 신청 위저드',
    ],
  },
  {
    id: 'euler-math',
    title: '오일러 수학 영재학술원 & 올림피아드',
    client: '가상 브랜드 샘플 — 실제 업체가 아닙니다 (영재 수학학원 설정)',
    category: 'education',
    categoryName: '학원 · 영재수학/올림피아드',
    summary: '3D 정다면체 오일러 공식(V-E+F=2) 시뮬레이터 & KMO 기출 논증 해체',
    description: 'KMO 올림피아드 및 영재학교 심층 구술면접 전문 수학학원 공식 웹사이트입니다. 플라톤 5대 정다면체 3D 회전 와이어프레임 & 오일러 공식(V - E + F = 2) 실시간 검증 Canvas Lab, KMO 기출 킬러 문항 단계별 엄밀 논증 해체, 영재학교 구술면접 로드맵, 1:1 영재성 정밀 진단평가 신청 위저드를 제공합니다.',
    thumbnailUrl: '/portfolio/euler-math/desktop.png',
    liveDemoUrl: '/demo/euler-math',
    techStack: ['Next.js 16', 'React 19', 'Tailwind CSS v4', 'TypeScript', 'HTML5 3D Canvas Matrix', 'Euler Characteristic Lab'],
    period: '2주',
    year: '2026',
    badge: '실물 라이브 데모',
    highlights: [
      '플라톤 5대 정다면체 3D 회전 와이어프레임 & 오일러 공식 실시간 검증 Canvas Lab',
      '꼭짓점(V)·모서리(E)·면(F) 카운터 및 위상수학적 불변량 텔레메트리 HUD',
      'KMO 1차·2차 및 영재학교 심층 구술면접 기출 발문 핀셋 논증 해체(예시)',
      '1:1 영재성 정밀 수리 진단평가 및 심층 면접 예약 위저드',
    ],
  },
  {
    id: 'mmi-essay',
    title: '아고라 논술 & MMI 의대면접 센터',
    client: '가상 브랜드 샘플 — 실제 업체가 아닙니다 (대입 논술 & 의대면접 학원 설정)',
    category: 'education',
    categoryName: '학원 · 대입논술/의대MMI',
    summary: '빨간펜 첨삭 전후(Before/After) 듀얼 비교 & 8분 의대 MMI 시뮬레이터',
    description: '대입 인문·수리논술 및 의대 MMI 다면 심층면접 전문 교육기관 공식 웹사이트입니다. 초안과 첨삭본을 실시간 비교하는 빨간펜 크리틱 인터랙티브 Lab, 8분 타이머 연동 의과대학 MMI 생명윤리 딜레마 & 꼬리질문 격파 시뮬레이터, 대학별 채점 기준표(Rubric), 1:1 서면 첨삭 및 모의면접 신청 위저드를 제공합니다.',
    thumbnailUrl: '/portfolio/mmi-essay/desktop.png',
    liveDemoUrl: '/demo/mmi-essay',
    techStack: ['Next.js 16', 'React 19', 'Tailwind CSS v4', 'TypeScript', 'Red-Pen Critique Dual Viewer', 'MMI Timed Station Simulator'],
    period: '2주',
    year: '2026',
    badge: '실물 라이브 데모',
    highlights: [
      '초안(Before)과 최종 첨삭본(After)을 1:1로 비교하는 빨간펜 크리틱 인터랙티브 Lab',
      '8분 타이머 연동 의과대학 MMI 생명윤리 딜레마 & 꼬리질문 격파 시뮬레이터',
      '대학별 채점 기준표(Rubric)에 맞춘 단락별 두괄식 논증 가이드',
      '1:1 논술 답안 서면 진단평가 및 MMI 심층 모의면접 예약 위저드',
    ],
  },
  {
    id: 'robot-stem',
    title: '키네틱스 영재로봇공학 & STEM 센터',
    client: '가상 브랜드 샘플 — 실제 업체가 아닙니다 (영재 로보틱스 학원 설정)',
    category: 'education',
    categoryName: '학원 · 영재로봇공학/STEM',
    summary: '4자유도 로봇암 기구 분해도(Exploded View) & 실시간 C++ 코드 연동 시뮬레이터',
    description: '단순 조립식 교구를 넘어 기구학(Kinematics)과 임베디드 회로, C++ 및 ROS 2 소프트웨어 알고리즘의 본질을 체계적으로 교육하는 하이테크 STEM 영재학술원 공식 웹사이트입니다. 4자유도(4-DOF) 로봇암 분해도 조립/분해 인터랙션, 관절 각도 조작 시 실시간 C++ 아두이노 코드 동기화 Live Telemetry, 수강생 실물 하드웨어 프로젝트 아카이브, 1:1 공학 적성 체험 신청 위저드를 제공합니다.',
    thumbnailUrl: '/portfolio/robot-stem/desktop.png',
    liveDemoUrl: '/demo/robot-stem',
    techStack: ['Next.js 16', 'React 19', 'Tailwind CSS v4', 'TypeScript', '4-DOF Kinematics Lab', 'Embedded Code Sync'],
    period: '2주',
    year: '2026',
    badge: '실물 라이브 데모',
    highlights: [
      '4자유도(4-DOF) 로봇암 기구 분해도(Exploded View) 조립/분해 인터랙션',
      '관절 슬라이더 회전각 연동 SVG Kinematics & Live C++ 아두이노 코드 동기화',
      '수강생 실물 하드웨어 & 자율주행 알고리즘 포트폴리오 아카이브',

...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  ...
  },
  {
    ...
    summary: '산업 전문가 매칭 및 안심 에스크로 결제 풀스택 플랫폼',
    description:
      '건축, 인테리어, 설비 산업의 의뢰인과 전문 시공팀을 연결하는 엔터프라이즈 B2B2C 플랫폼입니다. 7단계 견적 라이프사이클 관리, PASS 본인인증, 포트원 에스크로 결제 연동을 통해 거래 투명성을 보장합니다.',
